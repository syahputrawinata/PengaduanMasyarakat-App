    ...
    <div class="d-flex justify-content-center flex-column" style="margin-top: 10%">
        ...
        <div class="d-block m-auto">
            @if (Auth::user()->role == 'head_staff')
                <a href="{{ route('user.userIndex') }}" class="btn btn-info mt-3">Kembali</a>
            @elseif (Auth::user()->role == 'staff')
                <a href="{{ route('staff.index') }}" class="btn btn-info mt-3">Kembali</a>
            @else
                <a href="{{ route('report.index') }}" class="btn btn-info mt-3">Kembali</a>
            @endif
        </div>
    </div>
